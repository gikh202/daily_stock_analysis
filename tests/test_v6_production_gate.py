...
def test_production_gate_requires_exact_normalized_write_read_and_retirement() -> None:
...
def test_production_gate_treats_manual_legacy_fallback_as_diagnostic_only() -> None:
    ...
    assert gate["legacy_policy"] == "projection_retirement_ready_observation_window"
