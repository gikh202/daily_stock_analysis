...
def check_content_integrity(
    ...
    *,
    ...
    """Compatibility facade for the extracted content-integrity policy."""
    return _check_content_integrity_policy(
        result,
...
def apply_placeholder_fill(result: "AnalysisResult", missing_fields: List[str]) -> None:
    """Compatibility facade for the extracted placeholder-repair policy."""
    _apply_placeholder_fill_policy(result, missing_fields)
...
class AnalysisResult:
    ...
    search_performed: bool = False  # 是否执行联网搜索
