# -*- coding: utf-8 -*-
"""Compatibility facade for configuration metadata registry.

Canonical registry implementation belongs to the bootstrap/settings boundary.
"""
...
_IMPL_MODULE_NAME = "src.bootstrap.config_registry_impl"
