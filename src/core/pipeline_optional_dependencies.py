...
Optional integrations should never prevent the core stock-analysis pipeline
from starting. This module owns that fail-open construction policy so the main
pipeline composition root can focus on required dependency assembly.
"""
...
from src.core.pipeline_factory_registry import PipelineFactorySet


@dataclass(frozen=True)
class OptionalPipelineDependencies:
    """Optional collaborators that may be unavailable at runtime."""
...
def build_optional_pipeline_dependencies(
    *,
    ...
    """Build optional integrations while preserving historical fail-open policy."""
